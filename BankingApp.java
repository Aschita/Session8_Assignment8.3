package assignment_8c; //This java file is inside package named package1 inside src folder.

/*
 * This Assignment tested my skills on synchronization and Thread handling.
 */

public class BankingApp   //Class declaration containing main function.
{
	public static void main(String[] args)    //main function declaration. and because it is static, program execution starts from main function.  
	{
		...
		Customer firstCustomer = new Customer(commonObject , "Aschita");
		Customer secondCustomer = new Customer(commonObject , "Rajeshwari");
